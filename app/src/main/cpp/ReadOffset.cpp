...
//    std::string test_oat = "/data/app/~~BB-vA7qXu3RTmOnbg9z9hg==/threads.thor-2MHAAyKgevL7Ukh95mm_XA==/oat/arm64/base.odex";
//    read_file = test_oat;
...
//    jstring jstr = env->NewStringUTF("/data/app/~~BB-vA7qXu3RTmOnbg9z9hg==/threads.thor-2MHAAyKgevL7Ukh95mm_XA==/base.apk");//turn to jstring
